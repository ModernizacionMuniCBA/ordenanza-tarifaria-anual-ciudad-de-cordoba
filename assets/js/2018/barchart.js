...
function initGraphs(){
  $(".atras-button").hide();
  d3.json("assets/data/2018/listaRamas.json", function(error, dataRamas) {
    d3.json("assets/data/2018/listaCategorias.json", function(error, data) {
...
function initBarChart(){
  d3.json("assets/data/2018/listaRamas.json", function(error, data) {
    drawBarChart(data);
  });
}
...
function drawTM(){
  d3.json("assets/data/2018/listaActividades.json", function(error, actividades) {
    $("#tree-chart").empty();
...
function drawActivities(filterValue){
  d3.json("assets/data/2018/listaActividades.json", function(error, data) {
    // console.log(data);
